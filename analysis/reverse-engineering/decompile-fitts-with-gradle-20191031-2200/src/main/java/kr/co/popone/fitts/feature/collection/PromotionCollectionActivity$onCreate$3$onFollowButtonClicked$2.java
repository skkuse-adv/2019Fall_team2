...
final class PromotionCollectionActivity$onCreate$3$onFollowButtonClicked$2<T1, T2> implements BiConsumer<FollowResult, Throwable> {
    final /* synthetic */ long $userID;
    final /* synthetic */ PromotionCollectionActivity$onCreate$3 this$0;

    PromotionCollectionActivity$onCreate$3$onFollowButtonClicked$2(PromotionCollectionActivity$onCreate$3 promotionCollectionActivity$onCreate$3, long j) {
    ...
    public final void accept(FollowResult followResult, Throwable th) {
        ...
        if (followResult != null) {
            this.this$0.this$0.updateListForFollow(this.$userID, true);
        }
    }
}
