...
final class ShowRoomAdapter$onBindViewHolder$6 implements OnClickListener {
    final /* synthetic */ ShowRoom $userInfo;
    final /* synthetic */ ShowRoomAdapter this$0;

    ShowRoomAdapter$onBindViewHolder$6(ShowRoomAdapter showRoomAdapter, ShowRoom showRoom) {
        this.this$0 = showRoomAdapter;
        this.$userInfo = showRoom;
    }

    public final void onClick(View view) {
        this.this$0.delegate.onFollowersCountClicked(this.$userInfo);
    }
}
