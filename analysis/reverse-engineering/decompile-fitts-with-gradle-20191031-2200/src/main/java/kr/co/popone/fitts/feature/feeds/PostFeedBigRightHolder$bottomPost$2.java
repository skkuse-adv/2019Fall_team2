...
final class PostFeedBigRightHolder$bottomPost$2 extends Lambda implements Function0<PostFeedView> {
    final /* synthetic */ View $itemView;

    PostFeedBigRightHolder$bottomPost$2(View view) {
        this.$itemView = view;
        super(0);
    }
    ...
    public final PostFeedView invoke() {
        View findViewById = this.$itemView.findViewById(C0010R$id.viewNormalPostBottom);
