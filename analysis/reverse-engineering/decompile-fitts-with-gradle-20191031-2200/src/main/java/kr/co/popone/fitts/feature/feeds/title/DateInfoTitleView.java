...
public final class DateInfoTitleView extends FrameLayout {
    ...
    public DateInfoTitleView(@NotNull Context context, @Nullable String str, @Nullable String str2, @Nullable String str3) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        super(context);
        this.view = LayoutInflater.from(context).inflate(C0013R$layout.view_date_type_title, this);
        ...
        this.titleSubView = (TextView) view3.findViewById(C0010R$id.tvPostTodaySubTitle);
