...
public final class EventShopWebActivity$onCreate$2 extends WebViewClient {
    final /* synthetic */ EventShopWebActivity this$0;

    EventShopWebActivity$onCreate$2(EventShopWebActivity eventShopWebActivity) {
    ...
    public void onReceivedHttpError(@NotNull WebView webView, @NotNull WebResourceRequest webResourceRequest, @NotNull WebResourceResponse webResourceResponse) {
        ...
        if (areEqual) {
            ...
            ConstraintLayout constraintLayout2 = (ConstraintLayout) this.this$0._$_findCachedViewById(C0010R$id.applyGuideLayout);
            Intrinsics.checkExpressionValueIsNotNull(constraintLayout2, "applyGuideLayout");
