...
public final class OrderReservationCompleteFragment extends Fragment {
    public static final Companion Companion = new Companion(null);
    /* access modifiers changed from: private */
    public static final String KEY_ORDER_ID = StringKeyGenerator.Companion.generate(OrderReservationCompleteFragment.class, "key_order_id");
    ...
    public static final class Companion {
        ...
        @NotNull
        public final OrderReservationCompleteFragment newInstance(long j) {
            OrderReservationCompleteFragment orderReservationCompleteFragment = new OrderReservationCompleteFragment();
            Bundle bundle = new Bundle();
            bundle.putLong(OrderReservationCompleteFragment.KEY_ORDER_ID, j);
            orderReservationCompleteFragment.setArguments(bundle);
    ...
    @NotNull
    public static final OrderReservationCompleteFragment newInstance(long j) {
    ...
    public View onCreateView(@NotNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        return layoutInflater.inflate(C0013R$layout.fragment_order_reservation_complete, viewGroup, false);
    }

    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        Intrinsics.checkParameterIsNotNull(view, "view");
        super.onViewCreated(view, bundle);
        ((FrameLayout) _$_findCachedViewById(C0010R$id.backButton)).setOnClickListener(new OrderReservationCompleteFragment$onViewCreated$1(this));
        ((Button) _$_findCachedViewById(C0010R$id.buttonOrderDetail)).setOnClickListener(new OrderReservationCompleteFragment$onViewCreated$2(this));
        ((TextView) _$_findCachedViewById(C0010R$id.textCopyAccount)).setOnClickListener(new OrderReservationCompleteFragment$onViewCreated$3(this));
        ((ImageView) _$_findCachedViewById(C0010R$id.imageOrderState)).setOnClickListener(new OrderReservationCompleteFragment$onViewCreated$4(this));
        ...
        orderPushRendingViewModel2.getOrderDetailViewDataLiveData().observe(new OrderReservationCompleteFragment$onViewCreated$6(this), new OrderReservationCompleteFragment$onViewCreated$7(this));
        OrderPushRendingViewModel orderPushRendingViewModel3 = this.viewModel;
        if (orderPushRendingViewModel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException(str);
        }
        orderPushRendingViewModel3.getErrorLiveData().observe(new OrderReservationCompleteFragment$onViewCreated$8(this), new OrderReservationCompleteFragment$onViewCreated$9(this));
    }
    ...
    public final void updateDepositUi(kr.co.popone.fitts.model.order.OrderDetailViewData r5) {
        ...
        L_0x0109:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: kr.co.popone.fitts.feature.push.order.OrderReservationCompleteFragment.updateDepositUi(kr.co.popone.fitts.model.order.OrderDetailViewData):void");
    }
