...
final class FollowingPostViewModel$updateLikeState$1<T> implements Consumer<LikeResult> {
    final /* synthetic */ long $postId;
    final /* synthetic */ FollowingPostViewModel this$0;

    FollowingPostViewModel$updateLikeState$1(FollowingPostViewModel followingPostViewModel, long j) {
        this.this$0 = followingPostViewModel;
        this.$postId = j;
    }

    public final void accept(LikeResult likeResult) {
        this.this$0.postLikeStateChangeEvent(this.$postId, false);
    }
}
