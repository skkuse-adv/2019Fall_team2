...
final class ModifyUserInfoActivity$onCreate$3<T> implements Consumer<CharSequence> {
    final /* synthetic */ ModifyUserInfoActivity this$0;

    ModifyUserInfoActivity$onCreate$3(ModifyUserInfoActivity modifyUserInfoActivity) {
