...
public final class PreRefundResponse {
    ...
    @NotNull
    public static /* synthetic */ PreRefundResponse copy$default(PreRefundResponse preRefundResponse, OrderListLineItemVariant orderListLineItemVariant, StoreInfo storeInfo2, RefundAccount refundAccount2, int i, Object obj) {
        if ((i & 1) != 0) {
            orderListLineItemVariant = preRefundResponse.orderLineItemVariant;
        }
        if ((i & 2) != 0) {
            storeInfo2 = preRefundResponse.storeInfo;
        }
        if ((i & 4) != 0) {
            refundAccount2 = preRefundResponse.refundAccount;
        }
        return preRefundResponse.copy(orderListLineItemVariant, storeInfo2, refundAccount2);
    }
    ...
    @NotNull
    public final PreRefundResponse copy(@NotNull OrderListLineItemVariant orderListLineItemVariant, @NotNull StoreInfo storeInfo2, @NotNull RefundAccount refundAccount2) {
        ...
        return new PreRefundResponse(orderListLineItemVariant, storeInfo2, refundAccount2);
    }
    ...
    public boolean equals(@org.jetbrains.annotations.Nullable java.lang.Object r3) {
        /*
            ...
            boolean r0 = r3 instanceof kr.co.popone.fitts.model.remote.refund.PreRefundResponse
            if (r0 == 0) goto L_0x0027
            kr.co.popone.fitts.model.remote.refund.PreRefundResponse r3 = (kr.co.popone.fitts.model.remote.refund.PreRefundResponse) r3
        ...
        L_0x0029:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kr.co.popone.fitts.model.remote.refund.PreRefundResponse.equals(java.lang.Object):boolean");
    }
    ...
    public String toString() {
        ...
        sb.append("PreRefundResponse(orderLineItemVariant=");
    ...
    public PreRefundResponse(@NotNull OrderListLineItemVariant orderListLineItemVariant, @NotNull StoreInfo storeInfo2, @NotNull RefundAccount refundAccount2) {
        Intrinsics.checkParameterIsNotNull(orderListLineItemVariant, "orderLineItemVariant");
        Intrinsics.checkParameterIsNotNull(storeInfo2, "storeInfo");
        Intrinsics.checkParameterIsNotNull(refundAccount2, "refundAccount");
