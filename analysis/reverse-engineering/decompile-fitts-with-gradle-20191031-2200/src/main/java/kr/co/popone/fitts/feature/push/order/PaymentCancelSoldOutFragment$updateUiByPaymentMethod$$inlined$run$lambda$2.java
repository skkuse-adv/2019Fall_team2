...
final class PaymentCancelSoldOutFragment$updateUiByPaymentMethod$$inlined$run$lambda$2<T> implements Consumer<Boolean> {
    final /* synthetic */ PaymentCancelSoldOutFragment this$0;

    PaymentCancelSoldOutFragment$updateUiByPaymentMethod$$inlined$run$lambda$2(PaymentCancelSoldOutFragment paymentCancelSoldOutFragment) {
