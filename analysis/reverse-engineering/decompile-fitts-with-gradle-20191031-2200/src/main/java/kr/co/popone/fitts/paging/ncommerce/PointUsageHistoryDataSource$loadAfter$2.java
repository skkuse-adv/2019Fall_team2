...
final class PointUsageHistoryDataSource$loadAfter$2<T> implements Consumer<Throwable> {
    final /* synthetic */ PointUsageHistoryDataSource this$0;

    PointUsageHistoryDataSource$loadAfter$2(PointUsageHistoryDataSource pointUsageHistoryDataSource) {
