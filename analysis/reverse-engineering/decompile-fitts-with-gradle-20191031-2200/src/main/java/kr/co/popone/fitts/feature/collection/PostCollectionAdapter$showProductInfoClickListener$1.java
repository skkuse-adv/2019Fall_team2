...
final class PostCollectionAdapter$showProductInfoClickListener$1 implements OnClickListener {
    final /* synthetic */ PostCollectionAdapter this$0;

    PostCollectionAdapter$showProductInfoClickListener$1(PostCollectionAdapter postCollectionAdapter) {
    ...
    public final void onClick(View view) {
        ...
        if (tag != null) {
            access$getDelegate$p.showProductInfo(((Integer) tag).intValue());
            return;
        }
