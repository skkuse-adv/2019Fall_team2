...
final class CartActivity$onCreate$12<T> implements Observer<CartLineItemsDomain> {
    final /* synthetic */ CartActivity this$0;

    CartActivity$onCreate$12(CartActivity cartActivity) {
    ...
    public final void onChanged(CartLineItemsDomain cartLineItemsDomain) {
        ...
        access$getCartAdatper$p.removeCartLineItems(cartLineItemsDomain);
    }
}
