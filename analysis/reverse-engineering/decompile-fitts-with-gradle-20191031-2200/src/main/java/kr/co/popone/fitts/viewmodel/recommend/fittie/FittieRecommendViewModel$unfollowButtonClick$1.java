...
final class FittieRecommendViewModel$unfollowButtonClick$1<T1, T2> implements BiConsumer<FollowResult, Throwable> {
    final /* synthetic */ long $id;
    final /* synthetic */ FittieRecommendViewModel this$0;

    FittieRecommendViewModel$unfollowButtonClick$1(FittieRecommendViewModel fittieRecommendViewModel, long j) {
    ...
    public final void accept(FollowResult followResult, Throwable th) {
        if (followResult != null) {
            this.this$0.postFollowStateChangeEvent(this.$id, false);
