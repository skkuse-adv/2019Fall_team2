...
final class ShowRoomAdapter$onBindViewHolder$8 implements OnClickListener {
    final /* synthetic */ Post $currentItem;
    final /* synthetic */ ShowRoomAdapter this$0;

    ShowRoomAdapter$onBindViewHolder$8(ShowRoomAdapter showRoomAdapter, Post post) {
    ...
    public final void onClick(View view) {
        ...
        access$getDelegate$p.onLikedClicked(post, view);
    }
}
