...
public class IconCompat extends CustomVersionedParcelable {
    ...
    private android.graphics.drawable.Drawable loadDrawableInner(android.content.Context r7) {
        ...
        L_0x00b3:
            ...
            int r5 = r6.mInt1     // Catch:{ RuntimeException -> 0x00c2 }
            android.content.res.Resources$Theme r7 = r7.getTheme()     // Catch:{ RuntimeException -> 0x00c2 }
            android.graphics.drawable.Drawable r7 = androidx.core.content.res.ResourcesCompat.getDrawable(r0, r5, r7)     // Catch:{ RuntimeException -> 0x00c2 }
            return r7
        L_0x00c2:
