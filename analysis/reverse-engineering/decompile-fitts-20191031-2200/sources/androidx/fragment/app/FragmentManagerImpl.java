...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
    ...
    private void throwException(RuntimeException runtimeException) {
        ...
        if (fragmentHostCallback != null) {
            try {
                fragmentHostCallback.onDump(str, null, printWriter, new String[0]);
            } catch (Exception unused) {
            }
        } else {
            dump(str, null, printWriter, new String[0]);
        }
  ...
  mth insns count: 411
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:127:0x0287  */
    ...
    public void moveToState(androidx.fragment.app.Fragment r16, int r17, int r18, int r19, boolean r20) {
        ...
        L_0x01d9:
            ...
            android.content.res.Resources r1 = r16.getResources()     // Catch:{ NotFoundException -> 0x01f4 }
            int r2 = r7.mContainerId     // Catch:{ NotFoundException -> 0x01f4 }
            java.lang.String r1 = r1.getResourceName(r2)     // Catch:{ NotFoundException -> 0x01f4 }
            goto L_0x01f6
        L_0x01f4:
                ...
                if (fragmentManagerState.mAdded != null) {
                    ...
                    while (true) {
                        ...
                        if (fragment3 == null) {
                            ...
                            sb5.append(fragmentManagerState.mAdded[i6]);
