...
public class ConstraintWidget {
    ...
    public void connect(Type type, ConstraintWidget constraintWidget, Type type2, int i, Strength strength, int i2) {
        ...
        if (type3 == type5) {
            if (type4 == type5) {
                ...
                int i7 = i2;
                connect(Type.TOP, constraintWidget5, type10, 0, strength4, i7);
                connect(Type.BOTTOM, constraintWidget5, type10, 0, strength4, i7);
                getAnchor(Type.CENTER).connect(constraintWidget.getAnchor(type2), 0, i3);
            }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:142:0x026b  */
    /* JADX WARNING: Removed duplicated region for block: B:148:0x02a0  */
