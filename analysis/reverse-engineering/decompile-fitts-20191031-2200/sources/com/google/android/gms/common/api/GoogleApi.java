...
public class GoogleApi<O extends ApiOptions> {
    ...
    private final <A extends AnyClient, T extends BaseImplementation$ApiMethodImpl<? extends Result, A>> T zaa(int i, @NonNull T t) {
        t.zau();
        this.zabm.zaa(this, i, (BaseImplementation$ApiMethodImpl<? extends Result, AnyClient>) t);
        return t;
    }
    ...
    public <A extends AnyClient, T extends BaseImplementation$ApiMethodImpl<? extends Result, A>> T doRead(@NonNull T t) {
        zaa(0, t);
        return t;
    }
    ...
    public <A extends AnyClient, T extends BaseImplementation$ApiMethodImpl<? extends Result, A>> T doWrite(@NonNull T t) {
        zaa(1, t);
        return t;
    }
    ...
    public <A extends AnyClient, T extends BaseImplementation$ApiMethodImpl<? extends Result, A>> T doBestEffortWrite(@NonNull T t) {
        zaa(2, t);
        return t;
    }
