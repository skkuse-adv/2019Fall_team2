...
final class MixedCollectionActivity$outputs$$inlined$with$lambda$4<T> implements Consumer<ArrayList<CollectionEntry>> {
    final /* synthetic */ MixedCollectionActivity this$0;

    MixedCollectionActivity$outputs$$inlined$with$lambda$4(MixedCollectionActivity mixedCollectionActivity) {
    ...
    public final void accept(ArrayList<CollectionEntry> arrayList) {
        ...
        access$getMixedCollectionAdapter$p.addAll(arrayList);
    }
}
