...
final class FollowingPostViewModel$updateFollowState$1<T> implements Consumer<FollowResult> {
    final /* synthetic */ long $userId;
    final /* synthetic */ FollowingPostViewModel this$0;

    FollowingPostViewModel$updateFollowState$1(FollowingPostViewModel followingPostViewModel, long j) {
        this.this$0 = followingPostViewModel;
        this.$userId = j;
    }

    public final void accept(FollowResult followResult) {
        this.this$0.postFollowStateChangeEvent(this.$userId, false);
    }
}
