...
public final class FittieSearchResultModule {
    @NotNull
    public final SearchResultViewModel provideStoreViewModel(@NotNull FittieSearchResultFragment fittieSearchResultFragment, @NotNull SearchResultViewModelFactory searchResultViewModelFactory) {
        Intrinsics.checkParameterIsNotNull(fittieSearchResultFragment, "fragment");
        Intrinsics.checkParameterIsNotNull(searchResultViewModelFactory, "viewModelFactory");
        Fragment parentFragment = fittieSearchResultFragment.getParentFragment();
    ...
    public final kr.co.popone.fitts.viewmodel.search.result.SearchResultViewModelFactory providesViewModelFactory(@org.jetbrains.annotations.NotNull kr.co.popone.fitts.feature.search.view.FittieSearchResultFragment r7, @org.jetbrains.annotations.NotNull kr.co.popone.fitts.repository.SearchRepository r8, @org.jetbrains.annotations.NotNull kr.co.popone.fitts.repository.UserRepository r9, @org.jetbrains.annotations.NotNull kr.co.popone.fitts.eventtracker.EventTracker r10, @org.jetbrains.annotations.NotNull kr.co.popone.fitts.model.log.ActionLogAPI r11) {
        ...
        L_0x0030:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kr.co.popone.fitts.viewmodel.search.result.FittieSearchResultModule.providesViewModelFactory(kr.co.popone.fitts.feature.search.view.FittieSearchResultFragment, kr.co.popone.fitts.repository.SearchRepository, kr.co.popone.fitts.repository.UserRepository, kr.co.popone.fitts.eventtracker.EventTracker, kr.co.popone.fitts.model.log.ActionLogAPI):kr.co.popone.fitts.viewmodel.search.result.SearchResultViewModelFactory");
    }
}
