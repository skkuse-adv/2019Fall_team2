...
final class CategorySearchFragment$getPostFeeds$5<T> implements Observer<NetworkState> {
    final /* synthetic */ CategorySearchFragment this$0;

    CategorySearchFragment$getPostFeeds$5(CategorySearchFragment categorySearchFragment) {
    ...
    public final void onChanged(NetworkState networkState) {
        ...
        this.this$0.postFeedAdapter.updateNetworkState(networkState);
    }
}
