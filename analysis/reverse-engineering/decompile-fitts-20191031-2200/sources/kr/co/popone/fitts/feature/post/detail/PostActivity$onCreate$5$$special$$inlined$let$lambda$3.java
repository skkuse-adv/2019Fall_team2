...
final class PostActivity$onCreate$5$$special$$inlined$let$lambda$3 implements OnClickListener {
    final /* synthetic */ TextView $this_run;
    final /* synthetic */ User $user$inlined;
    final /* synthetic */ PostActivity$onCreate$5 this$0;

    PostActivity$onCreate$5$$special$$inlined$let$lambda$3(TextView textView, User user, PostActivity$onCreate$5 postActivity$onCreate$5, Post post) {
    ...
    public final void onClick(View view) {
        ...
        if (!isFollowing) {
            ...
            postActivity.putFollowRequest = postActivity.getUserAPI().putFollow(this.$user$inlined.getId()).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((BiConsumer<? super T, ? super Throwable>) new BiConsumer<FollowResult, Throwable>(this) {
                final /* synthetic */ PostActivity$onCreate$5$$special$$inlined$let$lambda$3 this$0;
