...
public final class SimpleInnerOffsetDecorator extends ItemDecoration {
    private final int bottom;
    private final int left;
    private final int right;
    private final int top;

    public SimpleInnerOffsetDecorator(int i, int i2, int i3, int i4) {
        this.top = i;
        this.left = i2;
        this.right = i3;
        this.bottom = i4;
    ...
    public void getItemOffsets(@NotNull Rect rect, @NotNull View view, @NotNull RecyclerView recyclerView, @NotNull State state) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(adapter, "adt");
