...
final class CreatePostViewModel$isStyleButtonValidate$2<T> implements Consumer<ValidationTextColor> {
    final /* synthetic */ CreatePostViewModel this$0;

    CreatePostViewModel$isStyleButtonValidate$2(CreatePostViewModel createPostViewModel) {
        this.this$0 = createPostViewModel;
    }

    public final void accept(ValidationTextColor validationTextColor) {
        this.this$0.getStyleTagValidate().onNext(validationTextColor);
    }
}
