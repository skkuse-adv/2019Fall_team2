...
final class PromotionCollectionAdapter$likeButtonListener$1 implements OnClickListener {
    final /* synthetic */ PromotionCollectionAdapter this$0;

    PromotionCollectionAdapter$likeButtonListener$1(PromotionCollectionAdapter promotionCollectionAdapter) {
    ...
    public final void onClick(View view) {
        ...
        if (tag != null) {
            access$getDelegate$p.onLikeButtonClicked(((Integer) tag).intValue());
            return;
        }
