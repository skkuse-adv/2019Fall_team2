...
public final class ProductPostDecorator extends ItemDecoration {
    public void getItemOffsets(@NotNull Rect rect, @NotNull View view, @NotNull RecyclerView recyclerView, @NotNull State state) {
        ...
        if (childAdapterPosition == 0) {
            rect.set(ViewExtensionsKt.dpToPx(view, 24), ViewExtensionsKt.dpToPx(view, 0), ViewExtensionsKt.dpToPx(view, 2), ViewExtensionsKt.dpToPx(view, 0));
        } else if (childAdapterPosition == itemCount - 1) {
            rect.set(ViewExtensionsKt.dpToPx(view, 2), ViewExtensionsKt.dpToPx(view, 0), ViewExtensionsKt.dpToPx(view, 24), ViewExtensionsKt.dpToPx(view, 0));
        } else {
