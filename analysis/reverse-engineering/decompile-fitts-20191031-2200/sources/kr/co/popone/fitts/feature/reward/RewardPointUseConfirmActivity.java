...
public final class RewardPointUseConfirmActivity extends AppCompatActivity {
    public static final Companion Companion = new Companion(null);
    public static final int SUCCESS_RESULT_CODE = 1010;
    private HashMap _$_findViewCache;
    /* access modifiers changed from: private */
    public Disposable enrollRewardUseRequest;
    @NotNull
    ...
    public static final class Parameters implements Parcelable {
        ...
        public static class Creator implements android.os.Parcelable.Creator {
            ...
            public final Object createFromParcel(@NotNull Parcel parcel) {
                ...
                Parameters parameters = new Parameters(parcel.readString(), parcel.readString(), parcel.readString(), parcel.readInt(), parcel.readInt(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString());
                return parameters;
            }
        ...
        @NotNull
        public static /* synthetic */ Parameters copy$default(Parameters parameters, String str, String str2, String str3, int i, int i2, String str4, String str5, String str6, String str7, String str8, String str9, int i3, Object obj) {
            Parameters parameters2 = parameters;
            int i4 = i3;
            return parameters.copy((i4 & 1) != 0 ? parameters2.productUrl : str, (i4 & 2) != 0 ? parameters2.productColor : str2, (i4 & 4) != 0 ? parameters2.productSize : str3, (i4 & 8) != 0 ? parameters2.productPrice : i, (i4 & 16) != 0 ? parameters2.shippingFee : i2, (i4 & 32) != 0 ? parameters2.shippingName : str4, (i4 & 64) != 0 ? parameters2.shippingContact : str5, (i4 & 128) != 0 ? parameters2.shippingZipCode : str6, (i4 & 256) != 0 ? parameters2.shippingAddress1 : str7, (i4 & 512) != 0 ? parameters2.shippingAddress2 : str8, (i4 & 1024) != 0 ? parameters2.shippingMemo : str9);
        }
        ...
        @NotNull
        public final Parameters copy(@NotNull String str, @NotNull String str2, @NotNull String str3, int i, int i2, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7, @NotNull String str8, @NotNull String str9) {
            String str10 = str;
            ...
            Parameters parameters = new Parameters(str10, str11, str12, i, i2, str13, str14, str15, str16, str17, str18);
            return parameters;
        }
        ...
        public boolean equals(@Nullable Object obj) {
            if (this != obj) {
                if (obj instanceof Parameters) {
                    ...
                    if (Intrinsics.areEqual((Object) this.productUrl, (Object) parameters.productUrl) && Intrinsics.areEqual((Object) this.productColor, (Object) parameters.productColor) && Intrinsics.areEqual((Object) this.productSize, (Object) parameters.productSize)) {
        ...
        public String toString() {
            ...
            sb.append("Parameters(productUrl=");
        ...
        public Parameters(@NotNull String str, @NotNull String str2, @NotNull String str3, int i, int i2, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7, @NotNull String str8, @NotNull String str9) {
            Intrinsics.checkParameterIsNotNull(str, "productUrl");
            Intrinsics.checkParameterIsNotNull(str2, "productColor");
    ...
    public void onDestroy() {
        Disposable disposable = this.enrollRewardUseRequest;
        if (disposable != null) {
            disposable.dispose();
        }
        super.onDestroy();
