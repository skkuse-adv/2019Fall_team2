...
final class CartViewModel$createVariantsDetail$1<T1, T2> implements BiConsumer<CartLineItemsDomain, Throwable> {
    final /* synthetic */ CartViewModel this$0;

    CartViewModel$createVariantsDetail$1(CartViewModel cartViewModel) {
        this.this$0 = cartViewModel;
    }

    public final void accept(CartLineItemsDomain cartLineItemsDomain, Throwable th) {
        if (cartLineItemsDomain != null) {
            this.this$0.getCreatedCartLineItemLiveData().setValue(cartLineItemsDomain);
        } else {
