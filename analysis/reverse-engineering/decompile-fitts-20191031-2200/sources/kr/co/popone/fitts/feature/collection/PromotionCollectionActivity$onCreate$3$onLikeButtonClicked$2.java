...
final class PromotionCollectionActivity$onCreate$3$onLikeButtonClicked$2<T1, T2> implements BiConsumer<LikeResult, Throwable> {
    final /* synthetic */ long $postID;
    final /* synthetic */ PromotionCollectionActivity$onCreate$3 this$0;

    PromotionCollectionActivity$onCreate$3$onLikeButtonClicked$2(PromotionCollectionActivity$onCreate$3 promotionCollectionActivity$onCreate$3, long j) {
    ...
    public final void accept(LikeResult likeResult, Throwable th) {
        ...
        if (likeResult != null) {
            this.this$0.this$0.updateListForLikes(this.$postID, true);
        }
    }
}
