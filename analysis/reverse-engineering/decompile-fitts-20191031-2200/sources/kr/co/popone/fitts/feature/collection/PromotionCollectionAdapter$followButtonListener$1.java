...
final class PromotionCollectionAdapter$followButtonListener$1 implements OnClickListener {
    final /* synthetic */ PromotionCollectionAdapter this$0;

    PromotionCollectionAdapter$followButtonListener$1(PromotionCollectionAdapter promotionCollectionAdapter) {
    ...
    public final void onClick(View view) {
        ...
        if (tag != null) {
            access$getDelegate$p.onFollowButtonClicked(((Integer) tag).intValue());
            return;
        }
