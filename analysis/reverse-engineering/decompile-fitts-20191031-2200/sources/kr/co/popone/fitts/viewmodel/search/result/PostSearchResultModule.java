...
public final class PostSearchResultModule {
    @NotNull
    public final SearchResultViewModel provideStoreViewModel(@NotNull PostSearchResultFragment postSearchResultFragment, @NotNull SearchResultViewModelFactory searchResultViewModelFactory) {
        Intrinsics.checkParameterIsNotNull(postSearchResultFragment, "fragment");
        Intrinsics.checkParameterIsNotNull(searchResultViewModelFactory, "viewModelFactory");
        Fragment parentFragment = postSearchResultFragment.getParentFragment();
    ...
    public final kr.co.popone.fitts.viewmodel.search.result.SearchResultViewModelFactory providesViewModelFactory(@org.jetbrains.annotations.NotNull kr.co.popone.fitts.feature.search.view.PostSearchResultFragment r7, @org.jetbrains.annotations.NotNull kr.co.popone.fitts.repository.SearchRepository r8, @org.jetbrains.annotations.NotNull kr.co.popone.fitts.repository.UserRepository r9, @org.jetbrains.annotations.NotNull kr.co.popone.fitts.eventtracker.EventTracker r10, @org.jetbrains.annotations.NotNull kr.co.popone.fitts.model.log.ActionLogAPI r11) {
        ...
        L_0x0030:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kr.co.popone.fitts.viewmodel.search.result.PostSearchResultModule.providesViewModelFactory(kr.co.popone.fitts.feature.search.view.PostSearchResultFragment, kr.co.popone.fitts.repository.SearchRepository, kr.co.popone.fitts.repository.UserRepository, kr.co.popone.fitts.eventtracker.EventTracker, kr.co.popone.fitts.model.log.ActionLogAPI):kr.co.popone.fitts.viewmodel.search.result.SearchResultViewModelFactory");
    }
}
