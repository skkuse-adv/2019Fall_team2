...
public class ConstraintHorizontalLayout extends ConstraintWidgetContainer {
    ...
    public void addToSolver(androidx.constraintlayout.solver.LinearSystem r10) {
        /*
            r9 = this;
            java.util.ArrayList<androidx.constraintlayout.solver.widgets.ConstraintWidget> r0 = r9.mChildren
            int r0 = r0.size()
            if (r0 == 0) goto L_0x0063
            r0 = 0
            java.util.ArrayList<androidx.constraintlayout.solver.widgets.ConstraintWidget> r1 = r9.mChildren
            int r1 = r1.size()
            r4 = r9
        L_0x0010:
            if (r0 >= r1) goto L_0x004d
            java.util.ArrayList<androidx.constraintlayout.solver.widgets.ConstraintWidget> r2 = r9.mChildren
