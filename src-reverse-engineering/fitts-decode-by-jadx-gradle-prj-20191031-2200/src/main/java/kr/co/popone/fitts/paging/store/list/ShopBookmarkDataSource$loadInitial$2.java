...
final class ShopBookmarkDataSource$loadInitial$2<T> implements Consumer<Throwable> {
    final /* synthetic */ ShopBookmarkDataSource this$0;

    ShopBookmarkDataSource$loadInitial$2(ShopBookmarkDataSource shopBookmarkDataSource) {
