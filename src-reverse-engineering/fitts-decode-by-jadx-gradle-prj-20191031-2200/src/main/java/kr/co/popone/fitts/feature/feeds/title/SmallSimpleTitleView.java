...
public final class SmallSimpleTitleView extends FrameLayout {
    ...
    public SmallSimpleTitleView(@NotNull Context context, @Nullable String str, @Nullable String str2) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        super(context);
        this.view = LayoutInflater.from(context).inflate(C0013R$layout.view_small_type_title, this);
        View view2 = this.view;
        String str3 = "view";
        Intrinsics.checkExpressionValueIsNotNull(view2, str3);
        this.titleView = (TextView) view2.findViewById(C0010R$id.tvSmallTitle);
