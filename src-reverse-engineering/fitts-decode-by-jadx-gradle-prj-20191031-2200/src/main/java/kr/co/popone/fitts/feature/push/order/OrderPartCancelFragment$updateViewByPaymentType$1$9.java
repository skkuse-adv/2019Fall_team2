...
final class OrderPartCancelFragment$updateViewByPaymentType$1$9<T, R> implements Function<T, R> {
    public static final OrderPartCancelFragment$updateViewByPaymentType$1$9 INSTANCE = new OrderPartCancelFragment$updateViewByPaymentType$1$9();

    OrderPartCancelFragment$updateViewByPaymentType$1$9() {
    }
