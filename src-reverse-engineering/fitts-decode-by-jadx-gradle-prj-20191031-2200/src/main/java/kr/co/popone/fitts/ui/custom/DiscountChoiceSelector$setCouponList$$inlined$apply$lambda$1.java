...
final class DiscountChoiceSelector$setCouponList$$inlined$apply$lambda$1 extends Lambda implements Function1<__AdapterView_OnItemSelectedListener, Unit> {
    final /* synthetic */ List $coupons$inlined;
    final /* synthetic */ DiscountChoiceSelector this$0;

    @DebugMetadata(c = "kr.co.popone.fitts.ui.custom.DiscountChoiceSelector$setCouponList$1$1$1", f = "DiscountChoiceSelector.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: kr.co.popone.fitts.ui.custom.DiscountChoiceSelector$setCouponList$$inlined$apply$lambda$1$1 reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function6<CoroutineScope, AdapterView<?>, View, Integer, Long, Continuation<? super Unit>, Object> {
        ...
        private int p$2;
        private long p$3;
        final /* synthetic */ DiscountChoiceSelector$setCouponList$$inlined$apply$lambda$1 this$0;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (this.label != 0) {
                ...
                int i = this.p$2;
                if (i == 0) {
                    DiscountChoiceSelector.updateDiscount$default(this.this$0.this$0, Type.COUPON, null, null, null, 14, null);
                } else {
                    DiscountChoiceSelector$setCouponList$$inlined$apply$lambda$1 discountChoiceSelector$setCouponList$$inlined$apply$lambda$1 = this.this$0;
                    discountChoiceSelector$setCouponList$$inlined$apply$lambda$1.this$0.updateDiscount(Type.COUPON, null, (CouponInfo) discountChoiceSelector$setCouponList$$inlined$apply$lambda$1.$coupons$inlined.get(i - 1), null);
                }
    ...
    DiscountChoiceSelector$setCouponList$$inlined$apply$lambda$1(DiscountChoiceSelector discountChoiceSelector, List list) {
