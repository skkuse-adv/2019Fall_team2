...
public final class PostVerificationFinishNoticeActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView((int) C0013R$layout.activity_post_verification_finish_notice);
        ((Button) _$_findCachedViewById(C0010R$id.confirmButton)).setOnClickListener(new PostVerificationFinishNoticeActivity$onCreate$1(this));
        ((TextView) _$_findCachedViewById(C0010R$id.tvMoreInfoText)).setOnClickListener(new PostVerificationFinishNoticeActivity$onCreate$2(this));
    }
