...
final class LikedActivity$requestLikedPosts$1<T1, T2> implements BiConsumer<ArrayList<Post>, Throwable> {
    final /* synthetic */ LikedActivity this$0;

    LikedActivity$requestLikedPosts$1(LikedActivity likedActivity) {
        this.this$0 = likedActivity;
    }

    public final void accept(ArrayList<Post> arrayList, Throwable th) {
        this.this$0.isLoadingData = false;
        this.this$0.likeListRequest = null;
        if (arrayList != null) {
            ...
            this.this$0.postList.addAll(arrayList);
            RecyclerView recyclerView2 = (RecyclerView) this.this$0._$_findCachedViewById(C0010R$id.liked_list);
            Intrinsics.checkExpressionValueIsNotNull(recyclerView2, str);
            Adapter adapter2 = recyclerView2.getAdapter();
            if (adapter2 != null) {
                adapter2.notifyItemRangeInserted((this.this$0.postList.size() + 1) - arrayList.size(), arrayList.size());
                return;
            }
            return;
        }
