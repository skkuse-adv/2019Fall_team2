...
final class ShowRoomActivity$onActivityResult$3<T1, T2> implements BiConsumer<MyInfo, Throwable> {
    final /* synthetic */ ShowRoomActivity this$0;

    ShowRoomActivity$onActivityResult$3(ShowRoomActivity showRoomActivity) {
