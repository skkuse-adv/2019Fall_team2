...
final class FittieResultDataSource$loadAfter$2<T> implements Consumer<Throwable> {
    final /* synthetic */ FittieResultDataSource this$0;

    FittieResultDataSource$loadAfter$2(FittieResultDataSource fittieResultDataSource) {
