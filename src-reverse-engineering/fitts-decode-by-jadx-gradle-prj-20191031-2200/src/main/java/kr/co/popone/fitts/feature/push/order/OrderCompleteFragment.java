...
public final class OrderCompleteFragment extends Fragment {
    public static final Companion Companion = new Companion(null);
    /* access modifiers changed from: private */
    public static final String KEY_ORDER_ID = StringKeyGenerator.Companion.generate(OrderCompleteFragment.class, "key_order_id");
    /* access modifiers changed from: private */
    public static final String KEY_VARIANT_ID = StringKeyGenerator.Companion.generate(OrderCompleteFragment.class, "key_variant_id");
    private final float FITTS_CARD_IMAGE_RATIO = 0.6166667f;
    private final float GENERAL_IMAGE_RATIO = 0.4722222f;
    ...
    private final float SPECIAL_DISCOUNT_IMAGE_RATIO = 0.40833333f;
    ...
    public static final class Companion {
        ...
        @NotNull
        public final OrderCompleteFragment newInstance(long j, long j2) {
            OrderCompleteFragment orderCompleteFragment = new OrderCompleteFragment();
            Bundle bundle = new Bundle();
            bundle.putLong(OrderCompleteFragment.KEY_ORDER_ID, j);
            bundle.putLong(OrderCompleteFragment.KEY_VARIANT_ID, j2);
    ...
    @NotNull
    public static final OrderCompleteFragment newInstance(long j, long j2) {
    ...
    public View onCreateView(@NotNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        return layoutInflater.inflate(C0013R$layout.fragment_order_complete, viewGroup, false);
    }

    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        Intrinsics.checkParameterIsNotNull(view, "view");
        super.onViewCreated(view, bundle);
        ((FrameLayout) _$_findCachedViewById(C0010R$id.backButton)).setOnClickListener(new OrderCompleteFragment$onViewCreated$1(this));
        ((Button) _$_findCachedViewById(C0010R$id.buttonOrderDetail)).setOnClickListener(new OrderCompleteFragment$onViewCreated$2(this));
        ((Button) _$_findCachedViewById(C0010R$id.buttonGoPosting)).setOnClickListener(new OrderCompleteFragment$onViewCreated$3(this));
        OrderPushRendingViewModel orderPushRendingViewModel = this.viewModel;
        String str = "viewModel";
        if (orderPushRendingViewModel == null) {
            Intrinsics.throwUninitializedPropertyAccessException(str);
        }
        orderPushRendingViewModel.getOrderDetailViewDataLiveData().observe(new OrderCompleteFragment$onViewCreated$4(this), new OrderCompleteFragment$onViewCreated$5(this));
        OrderPushRendingViewModel orderPushRendingViewModel2 = this.viewModel;
        if (orderPushRendingViewModel2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException(str);
        }
        orderPushRendingViewModel2.getRefundAccountInputedLiveData().observe(new OrderCompleteFragment$onViewCreated$6(this), new OrderCompleteFragment$onViewCreated$7(this));
        OrderPushRendingViewModel orderPushRendingViewModel3 = this.viewModel;
        if (orderPushRendingViewModel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException(str);
        }
        orderPushRendingViewModel3.getExchangeRefundLiveData().observe(new OrderCompleteFragment$onViewCreated$8(this), new OrderCompleteFragment$onViewCreated$9(this));
        OrderPushRendingViewModel orderPushRendingViewModel4 = this.viewModel;
        if (orderPushRendingViewModel4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException(str);
        }
        orderPushRendingViewModel4.getErrorLiveData().observe(new OrderCompleteFragment$onViewCreated$10(this), new OrderCompleteFragment$onViewCreated$11(this));
    ...
    public final void updateOrderStateImage(OrderDetailViewData orderDetailViewData) {
        if (orderDetailViewData != null) {
            ...
            if (i == 1) {
                loadOrderStateImage(C0008R$drawable.img_order_complete_general, this.GENERAL_IMAGE_RATIO);
                updateOrderState(this.SCHEME_ALPHA, this.SCHEME_BETA);
            } else if (i == 2) {
                loadOrderStateImage(C0008R$drawable.img_order_complete_special_discount, this.SPECIAL_DISCOUNT_IMAGE_RATIO);
                updateOrderState(this.SCHEME_ALPHA_SPECIAL_DISCOUNT, this.SCHEME_BETA_SPECIAL_DISCOUNT);
            } else if (i == 3) {
                loadOrderStateImage(C0008R$drawable.img_order_complete_fittca, this.FITTS_CARD_IMAGE_RATIO);
                updateOrderState(this.SCHEME_ALPHA, this.SCHEME_BETA);
            }
        }
    }
    ...
    private final void updateOrderState(String str, String str2) {
        ((ImageView) _$_findCachedViewById(C0010R$id.imageOrderState)).setOnClickListener(new OrderCompleteFragment$updateOrderState$1(this, str, str2));
    }
