...
final class ModifyProfileActivity$onCreate$3 implements OnClickListener {
    final /* synthetic */ ModifyProfileActivity this$0;

    ModifyProfileActivity$onCreate$3(ModifyProfileActivity modifyProfileActivity) {
        this.this$0 = modifyProfileActivity;
    }

    public final void onClick(View view) {
        Intent intent = new Intent(this.this$0, ModifyBodyActivity.class);
