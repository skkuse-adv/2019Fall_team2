...
final class CartViewModel$removeVariantsDetail$1<T1, T2> implements BiConsumer<CartLineItemsDomain, Throwable> {
    final /* synthetic */ CartViewModel this$0;

    CartViewModel$removeVariantsDetail$1(CartViewModel cartViewModel) {
        this.this$0 = cartViewModel;
    }

    public final void accept(CartLineItemsDomain cartLineItemsDomain, Throwable th) {
        if (cartLineItemsDomain != null) {
            this.this$0.getRemovedCartLineItemLiveData().setValue(cartLineItemsDomain);
        } else {
