...
final class MixedCollectionViewModel$ViewModel$requestUnFollow$$inlined$let$lambda$1<T1, T2> implements BiConsumer<FollowResult, Throwable> {
    final /* synthetic */ int $index$inlined;
    final /* synthetic */ MixedCollectionViewModel$ViewModel this$0;

    MixedCollectionViewModel$ViewModel$requestUnFollow$$inlined$let$lambda$1(MixedCollectionViewModel$ViewModel mixedCollectionViewModel$ViewModel, int i) {
        this.this$0 = mixedCollectionViewModel$ViewModel;
        this.$index$inlined = i;
    }

    public final void accept(FollowResult followResult, Throwable th) {
        this.this$0.setUnfollowDisposable(null);
        if (followResult != null) {
            ...
            if (user != null) {
                this.this$0.notifyFollowResult(user, false);
                return;
            }
            return;
        }
