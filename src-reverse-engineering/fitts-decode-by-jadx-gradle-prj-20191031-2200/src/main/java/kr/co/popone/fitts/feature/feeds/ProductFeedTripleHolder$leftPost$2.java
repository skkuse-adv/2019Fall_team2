...
final class ProductFeedTripleHolder$leftPost$2 extends Lambda implements Function0<ProductTripleFeedView> {
    final /* synthetic */ View $itemView;

    ProductFeedTripleHolder$leftPost$2(View view) {
        this.$itemView = view;
        super(0);
    }
    ...
    public final ProductTripleFeedView invoke() {
        View findViewById = this.$itemView.findViewById(C0010R$id.view_first);
