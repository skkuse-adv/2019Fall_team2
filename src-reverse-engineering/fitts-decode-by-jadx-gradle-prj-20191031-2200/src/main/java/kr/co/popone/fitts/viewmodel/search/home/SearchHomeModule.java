...
public final class SearchHomeModule {
    @NotNull
    public final SearchViewModel provideHomeViewModel(@NotNull SearchHomeFragment searchHomeFragment, @NotNull SearchViewModelFactory searchViewModelFactory) {
        Intrinsics.checkParameterIsNotNull(searchHomeFragment, "fragment");
