...
public final class PointUsageHistoryModule {
    @NotNull
    public final NCommerceViewModel provideOrderViewModel(@NotNull PointUsageHistoryFragment pointUsageHistoryFragment, @NotNull NCommerceViewModelFactory nCommerceViewModelFactory) {
        Intrinsics.checkParameterIsNotNull(pointUsageHistoryFragment, "fragment");
        Intrinsics.checkParameterIsNotNull(nCommerceViewModelFactory, "viewModelFactory");
        ViewModel viewModel = ViewModelProviders.of((Fragment) pointUsageHistoryFragment, (Factory) nCommerceViewModelFactory).get(NCommerceViewModel.class);
