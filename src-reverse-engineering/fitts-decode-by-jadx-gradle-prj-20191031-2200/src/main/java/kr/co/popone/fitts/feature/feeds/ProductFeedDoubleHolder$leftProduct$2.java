...
final class ProductFeedDoubleHolder$leftProduct$2 extends Lambda implements Function0<ProductDoubleFeedView> {
    final /* synthetic */ View $itemView;

    ProductFeedDoubleHolder$leftProduct$2(View view) {
        this.$itemView = view;
        super(0);
    }
    ...
    public final ProductDoubleFeedView invoke() {
        View findViewById = this.$itemView.findViewById(C0010R$id.view_left);
