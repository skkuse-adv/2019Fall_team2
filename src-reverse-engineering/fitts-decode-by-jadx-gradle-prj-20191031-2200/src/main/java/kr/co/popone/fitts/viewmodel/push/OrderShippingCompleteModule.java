...
public final class OrderShippingCompleteModule {
    @NotNull
    public final OrderPushRendingViewModel provideOrderViewModel(@NotNull OrderShippingCompleteFragment orderShippingCompleteFragment, @NotNull OrderPushRendingViewModelFactory orderPushRendingViewModelFactory) {
        Intrinsics.checkParameterIsNotNull(orderShippingCompleteFragment, "fragment");
        Intrinsics.checkParameterIsNotNull(orderPushRendingViewModelFactory, "viewModelFactory");
        ViewModel viewModel = ViewModelProviders.of((Fragment) orderShippingCompleteFragment, (Factory) orderPushRendingViewModelFactory).get(OrderPushRendingViewModel.class);
