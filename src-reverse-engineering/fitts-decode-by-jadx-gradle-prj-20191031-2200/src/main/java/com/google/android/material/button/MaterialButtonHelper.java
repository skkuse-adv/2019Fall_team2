...
class MaterialButtonHelper {
    ...
    public void drawStroke(@Nullable Canvas canvas) {
        if (canvas != null && this.strokeColor != null && this.strokeWidth > 0) {
            ...
            rectF2.set(f + (((float) i) / 2.0f) + ((float) this.insetLeft), ((float) rect.top) + (((float) i) / 2.0f) + ((float) this.insetTop), (((float) rect.right) - (((float) i) / 2.0f)) - ((float) this.insetRight), (((float) rect.bottom) - (((float) i) / 2.0f)) - ((float) this.insetBottom));
