    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new RemoteUserInfo(RemoteUserInfo.LEGACY_CONTROLLER, Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    MediaSessionImplBase.this.setCurrentControllerInfo(new RemoteUserInfo(data.getString("data_calling_pkg"), data.getInt(MediaBrowserProtocol.DATA_CALLING_PID), data.getInt(MediaBrowserProtocol.DATA_CALLING_UID)));
        ...
        public void postToHandler(int i, int i2, int i3, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                if (this.mHandler != null) {
                    ...
                    bundle2.putString("data_calling_pkg", RemoteUserInfo.LEGACY_CONTROLLER);
