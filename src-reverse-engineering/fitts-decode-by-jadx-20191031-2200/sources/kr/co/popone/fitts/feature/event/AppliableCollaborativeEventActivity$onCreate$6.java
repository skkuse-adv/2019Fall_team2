...
final class AppliableCollaborativeEventActivity$onCreate$6 implements OnClickListener {
    final /* synthetic */ AppliableCollaborativeEventActivity this$0;

    AppliableCollaborativeEventActivity$onCreate$6(AppliableCollaborativeEventActivity appliableCollaborativeEventActivity) {
        ...
        if (access$getEventResponse$p != null) {
            ...
            if (!(sharedLink == null || StringsKt__StringsJVMKt.isBlank(sharedLink))) {
                ...
                findViewById4.setOnClickListener(new OnClickListener(this) {
                    final /* synthetic */ AppliableCollaborativeEventActivity$onCreate$6 this$0;
