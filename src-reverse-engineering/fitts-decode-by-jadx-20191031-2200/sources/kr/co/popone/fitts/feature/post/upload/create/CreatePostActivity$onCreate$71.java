...
final class CreatePostActivity$onCreate$71<T> implements Consumer<ValidationTextColor> {
    final /* synthetic */ CreatePostActivity this$0;

    CreatePostActivity$onCreate$71(CreatePostActivity createPostActivity) {
        this.this$0 = createPostActivity;
    }

    public final void accept(ValidationTextColor validationTextColor) {
        TextView textView = (TextView) this.this$0._$_findCachedViewById(C0010R$id.about_product_title);
        Intrinsics.checkExpressionValueIsNotNull(textView, "about_product_title");
