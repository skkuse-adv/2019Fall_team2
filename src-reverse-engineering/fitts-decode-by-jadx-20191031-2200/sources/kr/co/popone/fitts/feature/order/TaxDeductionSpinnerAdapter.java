...
public final class TaxDeductionSpinnerAdapter extends ArrayAdapter<String> {
    private final String[] objects;

    public TaxDeductionSpinnerAdapter(@NotNull Context context, @Nullable String[] strArr) {
