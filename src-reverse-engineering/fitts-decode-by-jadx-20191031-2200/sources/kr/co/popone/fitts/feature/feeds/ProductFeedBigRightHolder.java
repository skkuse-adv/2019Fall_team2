...
public final class ProductFeedBigRightHolder extends BaseViewHolder {
    ...
    public static final class Companion {
        public final int getId() {
            return C0013R$layout.item_feed_product_big_right;
        }
        ...
        @NotNull
        public final ProductFeedBigRightHolder create(@NotNull ViewGroup viewGroup, @NotNull Delegate delegate) {
            Intrinsics.checkParameterIsNotNull(viewGroup, "parent");
            Intrinsics.checkParameterIsNotNull(delegate, "delegate");
            View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(C0013R$layout.item_feed_product_big_right, viewGroup, false);
            Intrinsics.checkExpressionValueIsNotNull(inflate, "view");
            return new ProductFeedBigRightHolder(inflate, delegate);
        }
    }
    ...
    public ProductFeedBigRightHolder(@NotNull View view, @NotNull Delegate delegate2) {
    ...
    private final void initView(ProductFeedView productFeedView, FeedVariantInfo feedVariantInfo) {
        ...
        imageView.setOnClickListener(new ProductFeedBigRightHolder$initView$$inlined$with$lambda$1(this, feedVariantInfo));
    ...
    private final void initTitleView(Feed feed) {
        ...
        if (titleHeaderView != null) {
            ...
            frameLayout.setOnClickListener(new ProductFeedBigRightHolder$initTitleView$$inlined$let$lambda$1(titleHeaderView, this, feed));
            return;
        }
