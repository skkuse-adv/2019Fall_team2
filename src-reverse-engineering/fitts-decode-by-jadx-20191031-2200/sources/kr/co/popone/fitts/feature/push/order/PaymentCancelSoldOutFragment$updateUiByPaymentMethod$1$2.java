...
final class PaymentCancelSoldOutFragment$updateUiByPaymentMethod$1$2<T, R> implements Function<T, R> {
    public static final PaymentCancelSoldOutFragment$updateUiByPaymentMethod$1$2 INSTANCE = new PaymentCancelSoldOutFragment$updateUiByPaymentMethod$1$2();

    PaymentCancelSoldOutFragment$updateUiByPaymentMethod$1$2() {
    }
