...
final class AppliableCollaborativeEventActivity$onCreate$2 implements OnScrollChangeListener {
    final /* synthetic */ AppliableCollaborativeEventActivity this$0;

    AppliableCollaborativeEventActivity$onCreate$2(AppliableCollaborativeEventActivity appliableCollaborativeEventActivity) {
    ...
    public final void onScrollChange(@NotNull NestedScrollView nestedScrollView, int i, int i2, int i3, int i4) {
        ...
        CollaborativeEventImageListView collaborativeEventImageListView = (CollaborativeEventImageListView) this.this$0._$_findCachedViewById(C0010R$id.topImagesListView);
        Intrinsics.checkExpressionValueIsNotNull(collaborativeEventImageListView, "topImagesListView");
        int height = collaborativeEventImageListView.getHeight();
