...
public final class PostFeedBigRightHolder extends BaseViewHolder {
    ...
    public static final class Companion {
        public final int getId() {
            return C0013R$layout.item_feed_post_big_right;
        }
        ...
        @NotNull
        public final PostFeedBigRightHolder create(@NotNull ViewGroup viewGroup, @NotNull Delegate delegate) {
            Intrinsics.checkParameterIsNotNull(viewGroup, "parent");
            Intrinsics.checkParameterIsNotNull(delegate, "delegate");
            View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(C0013R$layout.item_feed_post_big_right, viewGroup, false);
            Intrinsics.checkExpressionValueIsNotNull(inflate, "view");
            return new PostFeedBigRightHolder(inflate, delegate);
        }
    }
    ...
    static {
        Class<PostFeedBigRightHolder> cls = PostFeedBigRightHolder.class;
    ...
    public PostFeedBigRightHolder(@NotNull View view, @NotNull Delegate delegate2) {
        Intrinsics.checkParameterIsNotNull(view, "itemView");
        Intrinsics.checkParameterIsNotNull(delegate2, "delegate");
        super(view);
        this.delegate = delegate2;
        this.headerArea = (FrameLayout) view.findViewById(C0010R$id.layoutHeaderView);
        this.bigPost$delegate = LazyKt__LazyJVMKt.lazy(new PostFeedBigRightHolder$bigPost$2(view));
        this.topPost$delegate = LazyKt__LazyJVMKt.lazy(new PostFeedBigRightHolder$topPost$2(view));
        this.bottomPost$delegate = LazyKt__LazyJVMKt.lazy(new PostFeedBigRightHolder$bottomPost$2(view));
    }
    ...
    private final void initView(PostFeedView postFeedView, FeedVariantInfo feedVariantInfo) {
        ...
        postFeedView.setOnClickListener(new PostFeedBigRightHolder$initView$$inlined$with$lambda$1(this, feedVariantInfo, postFeedView));
    ...
    private final void initTitleView(Feed feed) {
        ...
        if (titleHeaderView != null) {
            ...
            frameLayout.setOnClickListener(new PostFeedBigRightHolder$initTitleView$$inlined$let$lambda$1(titleHeaderView, this, feed));
            return;
        }
