...
final class PostFeedBigRightHolder$topPost$2 extends Lambda implements Function0<PostFeedView> {
    final /* synthetic */ View $itemView;

    PostFeedBigRightHolder$topPost$2(View view) {
        this.$itemView = view;
        super(0);
    }
    ...
    public final PostFeedView invoke() {
        View findViewById = this.$itemView.findViewById(C0010R$id.viewNormalPostTop);
