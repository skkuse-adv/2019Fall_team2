...
final class CouponUseActivity$onCreate$4<T> implements Consumer<CharSequence> {
    final /* synthetic */ CouponUseActivity this$0;

    CouponUseActivity$onCreate$4(CouponUseActivity couponUseActivity) {
    ...
    public final void accept(CharSequence charSequence) {
        ...
        if (charSequence.length() > 0) {
            ...
            couponUseActivity.linkInfoRequest = couponUseActivity.getPostAPI$app_productionFittsRelease().requestLinkInfo(charSequence.toString()).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((BiConsumer<? super T, ? super Throwable>) new BiConsumer<LinkInfo, Throwable>(this) {
                final /* synthetic */ CouponUseActivity$onCreate$4 this$0;
