...
final class ProductFeedTripleHolder$centerPost$2 extends Lambda implements Function0<ProductTripleFeedView> {
    final /* synthetic */ View $itemView;

    ProductFeedTripleHolder$centerPost$2(View view) {
        this.$itemView = view;
        super(0);
    }
    ...
    public final ProductTripleFeedView invoke() {
        View findViewById = this.$itemView.findViewById(C0010R$id.view_second);
