...
final class MixedCollectionAdapter$FittieTypeHolder$init$$inlined$with$lambda$2 implements OnClickListener {
    final /* synthetic */ int $position$inlined;
    final /* synthetic */ FittieTypeHolder this$0;

    MixedCollectionAdapter$FittieTypeHolder$init$$inlined$with$lambda$2(View view, FittieTypeHolder fittieTypeHolder, int i) {
