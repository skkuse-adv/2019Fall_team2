            ...
            if (weakReference != null && weakReference.get() != null && this.mCallbackImplRef.get() != null) {
                ...
                try {
                    ...
                    if (i == 1) {
                        ...
                        mediaBrowserServiceCallbackImpl.onServiceConnected(messenger, data.getString(str), (Token) data.getParcelable(MediaBrowserProtocol.DATA_MEDIA_SESSION_TOKEN), bundle);
                    } else if (i == 2) {
                        ...
                        mediaBrowserServiceCallbackImpl.onLoadChildren(messenger, data.getString(str), data.getParcelableArrayList(MediaBrowserProtocol.DATA_MEDIA_ITEM_LIST), bundle2, bundle3);
                    }
